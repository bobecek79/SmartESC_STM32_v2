...
/* Battery divider is 1M / 33k on this board (stock was 100k / 6.2k).
 *   theoretical stock ratio :  6.2 / (100 + 6.2)  = 0.05838
 *   empirical stock value   :  0.0535
 *   empirical trim          :  0.0535 / 0.05838   = 0.9164
 *   theoretical new ratio   :  33 / (1000 + 33)   = 0.031946
 *   same trim applied       :  0.031946 * 0.9164  = 0.029276  -> 0.0293
 */
#define VBUS_PARTITIONING_FACTOR      0.0293 /*!< It expresses how
                                                       much the Vbus is attenuated
                                                       before being converted into
                                                       digital value */
#define NOMINAL_BUS_VOLTAGE_V         54 /* 15S nominal (15 x 3.6 V); was 36 for 10S */
