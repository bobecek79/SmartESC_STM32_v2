...
#define MCCONF_L_MAX_VOLTAGE			70.0	// Maximum input voltage (15S: +11% over the 63 V full-charge pack, 30% below the 100 V FET/cap rating; was 56.0, which is below full charge and would fault immediately)
#endif
#ifndef MCCONF_L_BATTERY_CUT_START
#define MCCONF_L_BATTERY_CUT_START		45.0	// Start limiting the positive current at this voltage (15S: 3.00 V/cell; was 34.0 for 10S)
#endif
#ifndef MCCONF_L_BATTERY_CUT_END
#define MCCONF_L_BATTERY_CUT_END		40.0		// Limit the positive current completely at this voltage (15S: 2.67 V/cell; was 30.0 for 10S)
#endif
